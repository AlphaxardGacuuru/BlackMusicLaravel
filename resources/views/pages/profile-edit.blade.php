        ...
        <div class="contact-form form-group">
            <center>
                ...
                <div class="avatar-container border">
                    ...
                    <div class="overlay">
                        <button class="edit-button mysonar-btn"
                            onclick="document.getElementById('profile-pic').click();">EDIT</button>
                    </div>
                </div>
                {!! Form::open(['action' => ['HomeController@update', Auth::user()->id], 'method' => 'POST',
                'enctype' => 'multipart/form-data']) !!}
                <br>
                {{ Form::file('profile-pic', ['class' => 'form-control', 'id' => 'profile-pic', 'style' => 'display: none;']) }}
